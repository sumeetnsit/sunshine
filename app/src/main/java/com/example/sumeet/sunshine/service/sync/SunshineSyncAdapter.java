...
import com.example.sumeet.sunshine.R;
import com.example.sumeet.sunshine.Utility;
...
//                    authority, new Bundle(), syncInterval);
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            getWeatherDataFromJson(weatherForecast,14,postalCode);
    ...
    private String getWeatherForecastData(String postalCode) {
        ...
        String key = "3cb3283e714968860d865d309d9e9a57";
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon().appendQueryParameter(QUERY_PARAM,locationQuery).appendQueryParameter(FORMAT_PARAM,format).appendQueryParameter(UNITS_PARAM,units).appendQueryParameter(DAYS_PARAM,Integer.toString(numDays)).appendQueryParameter(API_KEY_PARAM,key).build();
